...
class mUNet(nn.Module):
    def __init__(self, array, channels = 1):
        ...
        #[64, 128, 256, 512, 1024]
        #下采样
        self.d1 = DownsampleLayer(array, 1,out_channels[0])
        #3-64
        self.d2 = DownsampleLayer(array, out_channels[0],out_channels[1])
        #64-128
        self.d3 = DownsampleLayer(array, out_channels[1],out_channels[2])
        #128-256
        self.d4 = DownsampleLayer(array, out_channels[2],out_channels[3])
        #256-512
        #上采样
        #self.u1 = UpSampleLayer(out_channels[3],out_channels[3])#512-1024-512
        self.u2 = UpSampleLayer(out_channels[2],out_channels[2])
        #1024-512-256
