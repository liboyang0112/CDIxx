...
cuFuncDec(interpolate, Real* out, Real* data0, Real* data1, Real dx);
cuFuncDec(interpolate, complexFormat* out, complexFormat* data0, complexFormat* data1, Real dx);
cuFuncDec(adamUpdateV, Real* v, Real* grad, Real beta2);
cuFuncDec(adamUpdateV, Real* v, complexFormat* grad, Real beta2);
cuFuncDec(adamUpdate, complexFormat* x, complexFormat* m, Real* v, Real lr, Real eps);
...
cuFuncDec(ccdRecord, uint16_t* data, Real* wave, int noiseLevel, curandStateMRG32k3a *state, Real exposure = 1);
cuFuncDec(ccdRecord, uint16_t* data, complexFormat* wave, int noiseLevel, curandStateMRG32k3a *state, Real exposure = 1);
cuFuncDec(ccdRecord, Real* data, Real* wave, int noiseLevel, curandStateMRG32k3a *state, Real exposure = 1);
cuFuncDec(ccdRecord, Real* data, complexFormat* wave, int noiseLevel, curandStateMRG32k3a *state, Real exposure = 1);
cuFuncDec(ccdRecord, complexFormat* data, complexFormat* wave, int noiseLevel, curandStateMRG32k3a *state, Real exposure = 1);
